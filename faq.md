...
```  
Solution: The client is configured to us a secured connection with SSL enabled. Disable SSL support in the client by using "ws://" for websocket connections instead of "wss://"
